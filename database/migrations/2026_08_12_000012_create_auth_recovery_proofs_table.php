...
return new class extends Migration
{
    ...
    {
        Schema::create('auth_recovery_proofs', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('auth_recovery_proof_outbox', function (Blueprint $table): void {
            $table->id();
    ...
    {
        Schema::dropIfExists('auth_recovery_proof_outbox');
        Schema::dropIfExists('auth_recovery_proofs');
    }
};
